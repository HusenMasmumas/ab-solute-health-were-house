...
const CreatePurchase = (props: Props) => {
        ...
        return (
          <InputNumber
            ...
            onChange={(value) => {
              ...
              if (typeof value === "number") setNewValue(value, record);
              else {
  ...
  useEffect(() => {
    setMotableData([
      ...historyData.filter((element: TableType) =>
        selectIndex.includes(element.index)
      ),
    ]);
    ...
    <div>
      ...
      <ContentContainer>
        <Card className="w-full">
          <div className="text-[#498DCB] text-[26px] !font-normal">
          ...
          />
          <div className="mt-5">
            <BlueButton onClick={() => setOpen(true)}>+ เพิ่มสินค้า</BlueButton>
            <Row>
              ...
              <Col sm={24} lg={12}>
                <Row className="mb-5 ">
                  <Col sm={9} offset={3}>
                    <div className="text-[15px] !font-normal h-full flex items-center">
                      รวมเป็นเงิน
                    </div>
                  </Col>
                  <Col sm={12}>
      ...
      <Modal
        title={
          <span className="text-[#498DCB] text-[18px]">รายละเอียดสินค้า</span>
        }
        centered
        open={open}
        footer={false}
